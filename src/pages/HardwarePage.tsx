...
// Static hardware data - IBM Quantum's 7 real QPUs
const hardwareProviders: HardwareProvider[] = [
  ...
  // Other providers - Coming Soon
  {
    ...
    qubits: 36,
    status: 'coming_soon',
    description: 'IonQ\'s enterprise-grade trapped ion quantum computer with industry-leading fidelity.',
    features: ['All-to-all connectivity', 'High fidelity gates', 'Long coherence time'],
    backendName: 'ionq_forte',
    apiRequired: true,
  ...
  },
  {
    ...
    qubits: 25,
    status: 'coming_soon',
    description: 'High-performance trapped ion system with excellent gate fidelities.',
    features: ['All-to-all connectivity', '#AQ 25', 'Cloud API'],
    backendName: 'ionq_aria',
    apiRequired: true,
    docsUrl: 'https://ionq.com',
  ...
  },
  {
    ...
    qubits: 84,
    status: 'coming_soon',
    description: 'Rigetti\'s 84-qubit system built on their new Ankaa architecture.',
    features: ['Hybrid classical-quantum', 'Quil language', 'AWS Braket'],
    backendName: 'rigetti_ankaa',
    apiRequired: true,
    docsUrl: 'https://rigetti.com',
    pricing: 'AWS Braket pricing'
  },
  {
    id: 'quantinuum_h2',
    name: 'Quantinuum H2',
    ...
    qubits: 56,
    status: 'coming_soon',
    description: 'World\'s highest performing quantum computer with 56 fully connected qubits.',
    features: ['All-to-all connectivity', 'Mid-circuit measurement', 'Qubit reuse'],
    backendName: 'quantinuum_h2',
    apiRequired: true,
    docsUrl: 'https://quantinuum.com',
    pricing: 'Enterprise pricing'
  },
  // QCloud Simulator
  {
    id: 'qcloud_simulator',
    name: 'QCloud Simulator',
    company: 'QCloud',
    type: 'simulator',
    qubits: 30,
    status: 'online',
    description: 'High-performance Qiskit Aer simulator running on our backend servers.',
    features: ['No queue time', 'Statevector access', 'Up to 30 qubits'],
